...
//printf("place 1\n");
					if(CF_v_C == 1)
					{
						...
						cf_or_c[invader][island] *= -1;						
	                        ...
	                        {
/*
					if(scalers[i][island] == INITIAL_CONTEXT_SCALER)
					{
						scalers[i][island] = INVADING_CONTEXT_SCALER;
					} else
					{
...
/*							if(ADDITIVE_KERNEL == true && COMPETE_TWO_SCALERS != 1)
                                                        {       
                                                                double output = 0;
                                                                int found = 0;
                                                ...
                                                printf("scalers before: %f\n", scalers[i][island]);               
                                                                scalers[i][island] += output;
printf("scalers after: %f\n", scalers[i][island]);
                                                        }*/

						

						double n1 = (double)rand() / RAND_MAX;
						scalers[i][island] = n1*2.0;
					//	printf("%f \n", n1*2.0);	
                                                ...
                                                {
//printf("in thresholds exist lol threshold %d is %f at time %d\n", i, thresholds[i][island], time);
...
*/
						...
						double n2 = (double)rand() / RAND_MAX;
                                                thresholds[i][island] = n2*2.0*INITIAL_CONTEXTFREE_THRESH;
