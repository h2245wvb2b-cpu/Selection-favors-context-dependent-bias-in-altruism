...
/* NOTE TO SELF: ORGANIZE THESEEEEE the setting can define the figure it was run forrrrr */
...
#define OLD_EMPIRICAL_THRESH 0
#define HAMILTON 1
double probIBD[POPULATION][PHENOTYPE_DIMENSION][ISLANDS];
double avgprobIBDs[POPULATION][ISLANDS];
double hamilton_distances[POPULATION][ISLANDS];
double average_distances[POPULATION][ISLANDS];
double numerical_thresh[POPULATION][ISLANDS];
double numerical_highscore[POPULATION][ISLANDS];
...
int store[POPULATION][10][ISLANDS];
